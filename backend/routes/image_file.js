...
router.get('/image_file', image_fileController.getAllImage_file);
router.post('/image_file', image_fileController.uploadImg, image_fileController.newImage_file); // upload.none() in the route, this enables our newImage_file function to read our form data; replace upload.none() to image_fileController.uploadImg
router.delete('/image_file', image_fileController.deleteAllImage_file);
